...
GRAPH /LINE = sum(index_change_pct) by time series 
      /TITLE='Percentage change: Total index  - Export'.

TEMPORARY.
SELECT IF (any(level,'Sitc 1') = 1 AND series = '3'). 
GRAPH /LINE = sum(index_change_pct) by time series 
      /TITLE='Percentage change: Index Sitc 1  - Export'.
...
GRAPH /LINE = sum(index_change_pct) by time series 
      /TITLE='Percentage change: Index Sitc 2  - Export'.
...
GRAPH /LINE = sum(index_change_pct) by time series 
      /TITLE='Percentage change: Index Commodity - HS8  - Export'.
